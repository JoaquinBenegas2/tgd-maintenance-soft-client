  ...
  return (
    <Collapsible className="mb-4" open={isExpanded} onOpenChange={setIsExpanded}>
      <CollapsibleTrigger asChild className="w-full">
        <button
          className="mb-1 transition-all flex w-full items-center px-3 py-2 text-left text-sm font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
      ...
      <CollapsibleContent className={`flex-1 flex flex-col space-y-2`}>
        {children}
      </CollapsibleContent>
    </Collapsible>
  );
