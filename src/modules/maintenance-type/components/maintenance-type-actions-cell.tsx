...
import MaintenanceTypeDeleteAlertDialog from "./maintenance-type-delete-alert-dialog";

export default function MaintenanceTypeActionsCell({ item }: { item: MaintenanceTypeResponseDto }) {
  ...
  return (
    <>
      ...
      {/* Delete Alert Dialog */}
      <MaintenanceTypeDeleteAlertDialog
        item={item}
